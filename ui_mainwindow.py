...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuBusqueda = QMenu(self.menubar)
        self.menuBusqueda.setObjectName(u"menuBusqueda")
        ...
        self.menuBusqueda.addAction(self.actionAmplitud)
        self.menuBusqueda.addAction(self.actionProfundidad)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAmplitud.setText(QCoreApplication.translate("MainWindow", u"Busqueda en amplitud", None))
        self.actionProfundidad.setText(QCoreApplication.translate("MainWindow", u"Busqueda en profundidad", None))
        ...
        self.menuBusqueda.setTitle(QCoreApplication.translate("MainWindow", u"Algoritmos", None))
    # retranslateUi
